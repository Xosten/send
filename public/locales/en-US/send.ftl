...
javascriptRequired = K-One Send requires JavaScript
whyJavascript = Why does K-One Send require JavaScript?
...
# K-One Send, Send, K-One, Mozilla are proper names and should not be localized
